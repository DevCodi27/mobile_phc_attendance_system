...
import com.code_red.phc_attendance_system.dto.ShiftStatusDTO;
...
public class ShiftController {
	...
	public ResponseEntity<Boolean> updateShift(@RequestBody ShiftStatusDTO shiftDTO, @PathVariable Long id) {
		return shiftService.updateShift(shiftDTO.getStatus(), HttpStatus.OK);
